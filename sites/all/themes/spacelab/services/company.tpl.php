...
<head> 
	...
	<style type="text/css" media="all">@import url("http://app.rruby.cn/sites/all/modules/ckeditor_link/ckeditor_link.css?n9h58l");</style>
		...
		body{line-height:1.6em;font-family:"Microsoft YaHei",微软雅黑,"Microsoft JhengHei","Arial","sans-serif";font-size:18px}
...
<body id="activity-detail">
        <div class="rich_media" style="margin-bottom:65px;">
...
?>							
 ...
 <table border="0" width="100%" style="line-height:18px;">
    <tr><td><?php print $contacts; ?></td><td rowspan="2" align="right" width="80"></td><td width="40" rowspan="2" align="right"><a href="tel:<?php print $phone; ?>" mce_href="tel:<?php print $phone; ?>"><img src="http://app.rruby.cn/sites/default/files/icon19.png" border="0" width="38" height="38"/></a></td></tr>
