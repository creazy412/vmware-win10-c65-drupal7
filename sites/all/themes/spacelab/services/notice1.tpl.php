...
<body id="activity-detail">
        ...
        <div class="rich_media_inner">
            ...
            <div class="rich_media_meta_list" style="">
                <img height="12px" width="12px" src="http://app.rruby.cn/sites/default/files/icon6.png" border="0"></img>&nbsp;<em id="post-date" class="rich_media_meta text"><?php print date('Y-m-d H:i:s',$node->changed); ?></em>
